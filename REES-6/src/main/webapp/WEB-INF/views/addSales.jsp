...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/admin/sales/checkCustomer" method="post" class="mb-4">
        <div class="mb-3">
    ...
    <% if (customer != null) { %>
        ...
        <form action="${pageContext.request.contextPath}/admin/sales/getPlots" method="post" class="mb-4">
    ...
    <% if (customer != null && selectedProject != null && plots != null) { %>
        <!-- Step 3: Select Plot -->
        <form action="${pageContext.request.contextPath}/admin/sales/checkSale" method="post" class="mb-4">
            <input type="hidden" name="phone" value="<%= customer.getContactNumber() %>" />
    ...
    <% if (saleExists != null && saleExists) { %>
        ...
        <form method="get" action="${pageContext.request.contextPath}/admin/sales/updateSales">
    ...
    <% } else if (customer != null && selectedProject != null && selectedPlot != null) { %>
        <!-- Step 4: Enter Sale Details -->
        <form method="post" action="${pageContext.request.contextPath}/admin/sales/submit">
            <input type="hidden" name="customerId" value="<%= customer.getCustomerId() %>" />
            <input type="hidden" name="projectId" value="<%= selectedProject.getProjectId() %>" />
            <input type="hidden" name="plotId" value="<%= selectedPlot.getPlotId() %>" />
